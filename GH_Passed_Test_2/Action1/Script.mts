...
Window("Notepad").WinEditor("Edit").Type "Test will PASS :)" @@ hightlight id_;_394372_;_script infofile_;_ZIP::ssf3.xml_;_
wait(1)
...
reporter.ReportEvent micPass,"test Passed 2","test Passed"
